...
export default function Header() {
  ...
  return (
    <header className='z-[10] relative'>
        <motion.div className='fixed top-0 left-1/2 h-[5rem] w-full rounded-none border border-white border-opacity-40 
        ...
        <nav className='flex fixed top-[0.15rem] left-1/2 h-12 -translate-x-1/2 py-2 sm:top-[1.7rem] sm:h-[initial] sm:py-0'>
            <ul className='flex w-[22rem] flex-wrap items-center justify-center gap-y-2 text-[0.9rem] font-sm sm:font-medium text-gray-500 sm:flex-nowrap sm:gap-5'>
                {links.map((link)=>(
