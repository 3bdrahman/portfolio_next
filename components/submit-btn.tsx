...
export default function SubmitButton() {
  ...
  return (
    <button className='group flex gap-2 h-[3rem] w-[8rem] bg-gray-900 rounded-full 
            outline-none transition-all text-white items-center justify-center focus:scale-110 hover:scale-110 active:scale-105 hover:bg-gray-950 disabled:scale-100 disabled:bg-opacity-60' 
